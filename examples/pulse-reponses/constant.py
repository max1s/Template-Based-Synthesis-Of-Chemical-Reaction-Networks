...
def form_crn():
    ...
    POne = Species('POne', initial_max=1, initial_value=0)
    PTwo = Species('PTwo', initial_max=1, initial_value=0.05)
    PThree = Species('PThree', initial_max=1, initial_value=0.5)
    POneStar = Species('POneStar', initial_max=1, initial_value=1)
    PTwoStar = Species('PTwoStar', initial_max=1, initial_value=0.95)
    PThreeStar = Species('PThreeStar', initial_max =1, initial_value=0.5)
    ...
    k24 = create_rate_constant('k_24', 1)
...
def synthesize_with_dreal(crn):
    ...
    sc = SolverCallerDReal("./constant.drh", dreal_path="../dReal-3.16.09.01-linux/bin/dReach")
